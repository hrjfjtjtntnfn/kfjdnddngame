-- Dump of database `nro_acc`
-- Host: 127.0.0.1

SET FOREIGN_KEY_CHECKS=0;
-- Dump tables and data only, use existing database
...
) ENGINE=InnoDB AUTO_INCREMENT=2413118 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Table structure for `account_mbbank`
-- ----------------------------
DROP TABLE IF EXISTS `account_mbbank`;
...
(1, 'https://ngocrongmobi.com/', '../image/logo.gif', 'hoat_dong', 'Ngọc Rồng Mobi - Trang Chủ', '1', '2', '3', '4', '8667F6AF5193D289A214C17E36672887', '', '', '');
...
CREATE TABLE `clan` (
  ...
  `TolaChienClan` int(11) NOT NULL,
    `TopBanDo` text NOT NULL,
    `TopKhiGas` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`TopKhiGas`)),
    `TopCDRD` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin CHECK (json_valid(`TopCDRD`)),
    `dataDoanhTrai` text NOT NULL,
    `dataDungeon` text,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Table structure for `diem_danh_history`
-- ----------------------------
DROP TABLE IF EXISTS `diem_danh_history`;
CREATE TABLE `diem_danh_history` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_player_day_date` (`player_id`,`day`,`date`),
  KEY `idx_player_id` (`player_id`),
  KEY `idx_date` (`date`),
  KEY `idx_diem_danh_history_player_date` (`player_id`,`date`)
...
-- ----------------------------
-- Table structure for `diem_danh_rewards`
-- ----------------------------
DROP TABLE IF EXISTS `diem_danh_rewards`;
CREATE TABLE `diem_danh_rewards` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_day_item_index` (`day`,`item_index`),
  KEY `idx_day` (`day`),
  KEY `idx_diem_danh_rewards_day_index` (`day`,`item_index`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng cấu hình phần thưởng điểm danh theo ngày trong tuần';

-- ----------------------------
-- Records of `diem_danh_rewards`
-- ----------------------------
...
(1, 1, 2412960, '116', 'game hay', '2025-07-02 17:43:55'),
(2, 1, 2412961, '117', 'game chán', '2025-07-02 17:44:57'),
(3, 3, 2412961, 'root', 'oke vipp', '2025-07-02 17:50:25'),
(4, 3, 2412960, '116', 'gamee oikeee', '2025-07-02 17:50:41'),
(5, 5, 2412960, '116', 'game được ấy', '2025-07-02 18:02:29');
...
(1, 2412960, '116', 'game hay', 'Game Rất Ok mUốn chơi miết', '2025-07-02 17:38:48', 'general', 0, 0),
(2, 2412960, '116', 'Bài viết test', 'Nội dung test', '2025-07-02 17:49:22', 'general', 0, 0),
(3, 2412960, '116', 'gaem dc', 'ádasdasds', '2025-07-02 17:50:09', 'general', 0, 0),
(4, 2412960, '116', 'game hay đó', 'game được lắm', '2025-07-02 17:52:26', 'general', 0, 0),
(5, 2412960, '116', 'toan', 'toan', '2025-07-02 17:56:01', 'general', 0, 0),
(6, 2412965, 'toanpro', 'game nào mở vậy', 'game hay mà mở laua quá', '2025-07-02 18:22:45', 'news', 0, 0);

-- ----------------------------
-- Table structure for `game_packages`
-- ----------------------------
...
(1, 'nrochay', 93268, '[{\"id\":343,\"quantity\":5,\"options\":[{\"param\":0,\"id\":83}]},{\"id\":380,\"quantity\":20,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1240,\"quantity\":1,\"options\":[{\"param\":8,\"id\":50},{\"param\":8,\"id\":77},{\"param\":8,\"id\":103},{\"param\":15,\"id\":101},{\"param\":0,\"id\":30}]}]', 'all', '2025-06-09 01:05:08', '2025-12-20 13:39:08'),
(2, 'tanthu', 92947, '[{\"id\":597,\"quantity\":10,\"options\":[{\"param\":0,\"id\":89}]},{\"id\":213,\"quantity\":1,\"options\":[{\"param\":8,\"id\":64}]},{\"id\":76,\"quantity\":5000000,\"options\":[{\"param\":32,\"id\":2}]},{\"id\":454,\"quantity\":1,\"options\":[{\"param\":0,\"id\":73}]},{\"id\":194,\"quantity\":1,\"options\":[{\"param\":0,\"id\":73}]},{\"id\":1136,\"quantity\":5,\"options\":[{\"param\":0,\"id\":30}]}]', 'all', '2025-06-09 01:00:36', '2025-12-19 15:36:40'),
(3, 'caitrang', 93925, '[{\"id\":227,\"quantity\":1,\"options\":[{\"param\":15,\"id\":50},{\"param\":15,\"id\":77},{\"param\":15,\"id\":103},{\"param\":5,\"id\":95},{\"param\":5,\"id\":96}]},{\"id\":228,\"quantity\":1,\"options\":[{\"param\":15,\"id\":50},{\"param\":15,\"id\":77},{\"param\":15,\"id\":103},{\"param\":5,\"id\":95},{\"param\":5,\"id\":96}]},{\"id\":229,\"quantity\":1,\"options\":[{\"param\":15,\"id\":50},{\"param\":15,\"id\":77},{\"param\":15,\"id\":103},{\"param\":5,\"id\":95},{\"param\":5,\"id\":96}]}]', '', '2025-06-09 01:00:29', '2025-10-19 19:19:29'),
(4, 'denbu3', 99697, '[{\"id\":1455,\"quantity\":200,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1456,\"quantity\":3,\"options\":[{\"param\":0,\"id\":30}]}]', 'all', '2025-06-03 13:24:53', '2025-12-20 13:39:08'),
(5, 'ádcvxvwesdfs', 99999, '[{\"id\":14,\"quantity\":30,\"options\":[{\"param\":1,\"id\":100},{\"param\":0,\"id\":86}]},{\"id\":77,\"quantity\":100000000,\"options\":[{\"param\":0,\"id\":73}]},{\"id\":861,\"quantity\":100000000,\"options\":[{\"param\":0,\"id\":73}]}]', 'all', '2025-05-25 07:50:26', '2025-12-20 13:39:08'),
(6, 'ádcvxvwesdfs', 99999, '[{\"id\":1276,\"quantity\":199,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1277,\"quantity\":199,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1278,\"quantity\":199,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1305,\"quantity\":99,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1167,\"quantity\":1,\"options\":[{\"param\":5,\"id\":50},{\"param\":5,\"id\":77},{\"param\":5,\"id\":103},{\"param\":5,\"id\":95},{\"param\":5,\"id\":96}]}]', 'all', '2025-05-18 07:57:46', '2025-12-20 13:39:08'),
(7, 'open', 99555, '[{\"id\":1341,\"quantity\":1,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1099,\"quantity\":15,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1100,\"quantity\":15,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1101,\"quantity\":15,\"options\":[{\"param\":0,\"id\":30}]}]', 'all', '2025-06-06 18:09:03', '2025-12-20 13:39:08'),
(8, 'nrochay1', 97930, '[{\"id\":381,\"quantity\":15,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":382,\"quantity\":15,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":383,\"quantity\":15,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":447,\"quantity\":20,\"options\":[{\"param\":5,\"id\":101}]}]', 'all', '2025-06-09 01:05:13', '2025-12-20 13:39:08'),
(9, 'code22', 99736, '[{\"id\":1181,\"quantity\":1,\"options\":[{\"param\":5,\"id\":50},{\"param\":15,\"id\":77},{\"param\":15,\"id\":103},{\"param\":5,\"id\":93},{\"param\":50,\"id\":2}]},{\"id\":1183,\"quantity\":1,\"options\":[{\"param\":5,\"id\":50},{\"param\":15,\"id\":77},{\"param\":15,\"id\":103},{\"param\":5,\"id\":93},{\"param\":50,\"id\":2}]},{\"id\":1185,\"quantity\":1,\"options\":[{\"param\":5,\"id\":50},{\"param\":15,\"id\":77},{\"param\":15,\"id\":103},{\"param\":5,\"id\":93},{\"param\":50,\"id\":2}]}]', 'all', '2025-06-07 00:44:34', '2025-12-20 13:39:08'),
(10, 'dsfcxvxc', 99447, '[{\"id\":1395,\"quantity\":99,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1099,\"quantity\":5,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1100,\"quantity\":5,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1101,\"quantity\":5,\"options\":[{\"param\":0,\"id\":30}]}]', 'all', '2025-05-18 07:58:14', '2025-12-20 13:39:08'),
(11, 'nrochay2', 97303, '[{\"id\":1305,\"quantity\":3,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1099,\"quantity\":5,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1100,\"quantity\":5,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1101,\"quantity\":5,\"options\":[{\"param\":0,\"id\":30}]}]', 'all', '2025-06-09 01:05:18', '2025-12-20 13:39:08'),
(12, '324324', 99682, '[{\"id\":1416,\"quantity\":1,\"options\":[{\"param\":26,\"id\":50},{\"param\":26,\"id\":77},{\"param\":26,\"id\":103},{\"param\":26,\"id\":101},{\"param\":15,\"id\":14}]},{\"id\":1450,\"quantity\":1,\"options\":[{\"param\":5,\"id\":50},{\"param\":3,\"id\":77},{\"param\":3,\"id\":103}]},{\"id\":1426,\"quantity\":3,\"options\":[{\"param\":0,\"id\":30}]}]', 'all', '2025-05-18 07:58:54', '2025-10-19 19:19:29'),
(13, 'gfdgdfg', 0, '[{\"id\":1316,\"quantity\":1,\"options\":[{\"param\":30,\"id\":50},{\"param\":29,\"id\":77},{\"param\":29,\"id\":103},{\"param\":25,\"id\":101},{\"param\":15,\"id\":14}]},{\"id\":1317,\"quantity\":1,\"options\":[{\"param\":10,\"id\":50},{\"param\":10,\"id\":77},{\"param\":10,\"id\":103}]}]', 'all', '2025-05-18 07:58:58', '2025-10-19 19:19:29'),
(14, 'wresfds', 0, '[{\"id\":1320,\"quantity\":1,\"options\":[{\"param\":29,\"id\":50},{\"param\":29,\"id\":77},{\"param\":29,\"id\":103},{\"param\":15,\"id\":5},{\"param\":25,\"id\":101}]},{\"id\":1328,\"quantity\":1,\"options\":[{\"param\":16,\"id\":50},{\"param\":16,\"id\":77},{\"param\":16,\"id\":103},{\"param\":8,\"id\":14}]}]', 'all', '2025-05-18 07:59:00', '2025-12-20 13:39:08'),
(15, 'sdgvfx', 0, '[{\"id\":1316,\"quantity\":1,\"options\":[{\"param\":32,\"id\":50},{\"param\":32,\"id\":77},{\"param\":32,\"id\":103},{\"param\":15,\"id\":5},{\"param\":32,\"id\":101}]},{\"id\":1317,\"quantity\":1,\"options\":[{\"param\":12,\"id\":50},{\"param\":16,\"id\":77},{\"param\":16,\"id\":103},{\"param\":8,\"id\":14}]}]', 'all', '2025-05-18 07:59:04', '2025-12-20 13:39:08'),
(16, 'dsfcxvwregwe', 88648, '[{\"id\":380,\"quantity\":30,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1099,\"quantity\":15,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1100,\"quantity\":15,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1101,\"quantity\":15,\"options\":[{\"param\":0,\"id\":30}]}]', 'all', '2025-05-18 07:59:07', '2025-12-20 13:39:08'),
(17, 'dsfcxvwregwe', 99816, '[{\"id\":1247,\"quantity\":5,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1099,\"quantity\":15,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1100,\"quantity\":15,\"options\":[{\"param\":0,\"id\":30}]},{\"id\":1101,\"quantity\":15,\"options\":[{\"param\":0,\"id\":30}]}]', 'all', '2025-05-18 07:59:07', '2025-12-20 13:39:08'),
(18, 'caitrang1', 99902, '[{\"id\":1485,\"quantity\":1,\"options\":[{\"param\":27,\"id\":50},{\"param\":27,\"id\":77},{\"param\":27,\"id\":103},{\"param\":10,\"id\":5},{\"param\":0,\"id\":30},{\"param\":2,\"id\":93}]}]', 'all', '2025-06-09 01:05:23', '2025-07-26 21:07:52');

-- ----------------------------
-- Table structure for `giftcode_diemdanh`
-- ----------------------------
DROP TABLE IF EXISTS `giftcode_diemdanh`;
...
-- ----------------------------
-- Table structure for `giftcode_diemdanh_reward`
-- ----------------------------
DROP TABLE IF EXISTS `giftcode_diemdanh_reward`;
...
-- ----------------------------
-- Records of `giftcode_diemdanh_reward`
-- ----------------------------
...
CREATE TABLE `history_transaction` (
  ...
  `time_tran` timestamp NOT NULL DEFAULT current_timestamp(),
    ...
    `detail_gold_2` text,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=46497 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Table structure for `items_web`
-- ----------------------------
...
-- ----------------------------
-- Table structure for `ket_qua_veso`
-- ----------------------------
DROP TABLE IF EXISTS `ket_qua_veso`;
...
-- ----------------------------
-- Records of `ket_qua_veso`
-- ----------------------------
INSERT INTO `ket_qua_veso` (`ngay`, `so`) VALUES
('2025-06-02', '09552');

-- ----------------------------
-- Table structure for `ket_qua_veso_nguoi_trung`
-- ----------------------------
DROP TABLE IF EXISTS `ket_qua_veso_nguoi_trung`;
...
(1, 'toanvip', '::1', 1, '2025-07-07 09:14:40'),
(2, 'abcbc', '::1', 1, '2025-07-07 09:46:54'),
(3, '1', '::1', 1, '2025-07-07 10:28:31'),
(4, '1', '::1', 1, '2025-07-07 10:50:38'),
(5, 'gamehayvl', '::1', 0, '2025-07-07 11:41:48'),
(6, 'toanvip', '::1', 1, '2025-07-07 11:42:06'),
(7, 'testgame', '::1', 1, '2025-07-07 13:11:38');

-- ----------------------------
-- Table structure for `mb_api_settings`
-- ----------------------------
DROP TABLE IF EXISTS `mb_api_settings`;
...
-- ----------------------------
-- Records of `mb_api_settings`
-- ----------------------------
INSERT INTO `mb_api_settings` (`id`, `setting_key`, `setting_value`, `description`, `updated_at`) VALUES
(1, 'api_key', '7a65a4a23e70c7bbdc05e3dc70e215a9', 'MBBank API Key from sieuthicode.net', '2025-06-29 22:18:43'),
(2, 'api_url', 'https://sieuthicode.net/api/mbbank', 'MBBank API Base URL', '2025-06-29 22:18:43'),
(3, 'callback_url', '', 'Webhook callback URL for transaction notifications', '2025-06-29 22:18:43'),
(4, 'webhook_secret', '', 'Secret key for webhook signature verification', '2025-06-29 22:18:43'),
(5, 'min_amount', '10000', 'Minimum transaction amount', '2025-06-29 22:18:43'),
(6, 'max_amount', '5000000', 'Maximum transaction amount', '2025-06-29 22:18:43'),
(7, 'auto_approve', '1', 'Auto approve successful transactions (1=yes, 0=no)', '2025-06-29 22:18:43');

-- ----------------------------
-- Table structure for `mb_transactions`
-- ----------------------------
DROP TABLE IF EXISTS `mb_transactions`;
CREATE TABLE `mb_transactions` (
  ...
  KEY `status` (`status`),
  KEY `created_at` (`created_at`),
  KEY `idx_mb_transactions_status_created` (`status`,`created_at`),
  KEY `idx_mb_transactions_username_status` (`username`,`status`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Records of `mb_transactions`
-- ----------------------------
...
(1, 'FT25188646650388', 'testgame', 2000, '', 'pending', NULL, NULL, NULL, NULL, '2025-07-07 15:23:26', '2025-07-07 15:23:26', 'CUSTOMER donate testgame   Ma giao dich  Tra ce874512 Trace 874512', '2025-07-07 10:23:26'),
(2, 'FT25188330807070', 'testgame', 2000, '', 'pending', NULL, NULL, NULL, NULL, '2025-07-07 15:23:26', '2025-07-07 15:23:26', 'CUSTOMER donate testgame   Ma giao dich  Tra ce806882 Trace 806882', '2025-07-07 10:23:26'),
(3, 'FT25188351306397', 'testgame', 2000, '', 'pending', NULL, NULL, NULL, NULL, '2025-07-07 15:48:47', '2025-07-07 15:48:47', 'CUSTOMER donate testgame   Ma giao dich  Tra ce058129 Trace 058129', '2025-07-07 10:48:47');
...
-- ----------------------------
-- Table structure for `mbbank_transactions`
-- ----------------------------
DROP TABLE IF EXISTS `mbbank_transactions`;
CREATE TABLE `mbbank_transactions` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `transaction_id` (`transaction_id`),
  KEY `idx_mbbank_user` (`username`),
  KEY `idx_mbbank_status` (`status`),
  KEY `idx_mbbank_created` (`created_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(105, 'meo', 'VIETTEL', '10010747233563', '711684349936730', 10000, 1, '773832097', '2025-05-06 09:00:30'),
(106, 'chienpk3', 'VIETTEL', '10011139733783', '813166130368611', 10000, 99, '593615083', '2025-05-18 11:41:46'),
(107, 'vuibeboi', 'VIETTEL', '10010822809581', '617332572657362', 20000, 99, '330432834', '2025-05-18 18:49:27');
...
CREATE TABLE `naptien` (
  ...
  `time` timestamp NULL DEFAULT current_timestamp(),
    ...
    `tranid` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
    `magioithieu` text,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `payments` (
  ...
  `status` varchar(50) NOT NULL,
    `bank` text,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=285 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `player` (
  ...
  `data_item_event` varchar(1000) NOT NULL DEFAULT '[]',
    `data_luyentap` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
) ENGINE=InnoDB AUTO_INCREMENT=10245918 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `super_rank` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=14530 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
-- ----------------------------
-- Table structure for `sv1_acc`
-- ----------------------------
DROP TABLE IF EXISTS `sv1_acc`;
...
-- ----------------------------
-- Table structure for `tamkjll_history_code`
-- ----------------------------
DROP TABLE IF EXISTS `tamkjll_history_code`;
CREATE TABLE `tamkjll_history_code` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=180515 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Lịch sử nhận gift code';

-- ----------------------------
-- Table structure for `tamkjllgift`
-- ----------------------------
DROP TABLE IF EXISTS `tamkjllgift`;
...
-- ----------------------------
-- Table structure for `trans_mbank`
-- ----------------------------
DROP TABLE IF EXISTS `trans_mbank`;
...
CREATE TABLE `transaction_logs` (
  ...
  KEY `username` (`username`),
  KEY `created_at` (`created_at`),
  KEY `idx_transaction_logs_transaction_action` (`transaction_id`,`action`)
